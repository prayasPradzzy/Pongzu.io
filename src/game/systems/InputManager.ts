...
export class InputManager {
  ...
  private readonly topLeft: Phaser.Input.Keyboard.Key;
  private readonly topRight: Phaser.Input.Keyboard.Key;
  ...
  constructor(scene: Phaser.Scene) {
    ...
    this.topLeft = keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.LEFT);
    this.topRight = keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.RIGHT);
  }
  ...
  getTopDirection() {
    return this.readDirection(this.topLeft.isDown, this.topRight.isDown);
  }
